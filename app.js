    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/hephaest-image-database/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
            ],
...
app.get('/', async (req, res) => {
    const limitNum = 5;
    const campgrounds = await Campground.find().sort({ 'rating': -1 }).populate('images', 'url').limit(limitNum);
